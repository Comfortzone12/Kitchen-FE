...
function Thanks() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-indigo-100 px-4">
      <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-2xl shadow-2xl backdrop-blur-sm bg-opacity-80 transition-all duration-300 ease-in-out hover:shadow-3xl">
        ...
        <div className="space-y-6 text-center">
          ...
          <div className="flex items-center justify-center gap-3 bg-green-50 p-4 rounded-lg transition-all duration-300 ease-in-out hover:bg-green-100">
            <Mail className="w-6 h-6 text-green-600" />
            <p className="text-lg text-gray-700">Please check your email for further updates.</p>
          </div>
        </div>
        <button 
          className="w-full py-4 px-6 bg-green-600 hover:bg-green-700 text-white text-lg font-semibold rounded-xl transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl hover:-translate-y-1"
